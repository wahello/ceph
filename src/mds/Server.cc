...
class C_MDS_SlaveLinkCommit : public ServerLogContext {
  CInode *targeti;
public:
...
struct C_MDS_SlaveRmdirCommit : public ServerLogContext {
...
class C_MDS_SlaveRenameCommit : public ServerLogContext {
  CDentry *srcdn, *destdn, *straydn;
public:
